...
ROOT_DATASET = '/data1/sdy/'  # '/data/jilin/'
...
def return_mydataset(modality):
    filename_categories = 7
    if modality == 'RGB':
        root_data = ROOT_DATASET
        filename_imglist_train = '/data1/sdy/rgb_train_videofolder.txt'
        filename_imglist_val = '/data1/sdy/rgb_val_videofolder.txt'
        prefix = 'img_{:05d}.jpg'
    elif modality == 'Flow':
        root_data = ROOT_DATASET + 'flow'
        filename_imglist_train = '/data1/sdy/flow_train_videofolder.txt'
        filename_imglist_val = '/data1/sdy/flow_val_videofolder.txt'
        prefix = 'flow_{}_{:05d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2,
                   ...
                   'kinetics': return_kinetics,'my_dataset': return_mydataset }
